    ...
    return (
      <div className="flex min-h-screen items-center justify-center px-5 safe-area-bottom">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] rounded-full bg-accent/[0.04] blur-[120px]" />
        ...
        <div className="relative w-full max-w-sm text-center animate-slide-up">
          ...
          <div className="mt-10 space-y-3">
            ...
            <a
              href="/login"
              className="block w-full rounded-2xl bg-white/[0.06] px-6 py-3.5 text-center text-sm font-medium text-foreground
                border border-border hover:bg-white/[0.1] transition-colors"
            >
      ...
      <nav className="safe-area-top">
        <div className="mx-auto max-w-7xl px-5 sm:px-6">
          <div className="flex h-14 items-center justify-between">
            ...
            <form action={async () => {
              'use server'
              const { signOut } = await import('@/src/actions/auth')
              await signOut()
            }}>
              <button
                type="submit"
